<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ExportToGL.ascx.cs" Inherits="RockWeb.Plugins.com_shepherdchurch.v5_financials.ExportToGL" %>
            ...
            (function ($) {
                function setup() {
                    ...
                    if (<%= IsExported %> == 1) {
                        ...
                        if ($('span.label-warning:contains("Open")').length >= 1) {
